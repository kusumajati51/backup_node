<template>
    <v-app light>
        <v-toolbar class="white">
            <v-toolbar-side-icon><img src="../assets/logo.png" alt="Vuetify.js" height="50"></v-toolbar-side-icon>
        ...
        <v-content>
                                ...
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        ...
                                        <v-card-text>
                                            ...
                                            won't only get positive feedback but also lovely and sincere fans
                                        </v-card-text>
                                    </v-card>
                                </v-flex>
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        ...
                                        <v-card-text>
                                            Imagine if you can directly speak with the world's population. Don't you
                                            think it would be easier to find nice people to interact with? Endorfine is
                                            both local and global and help you to connect without limitations with
            ...
            <section>
                <v-parallax src="../assets/backgroud/landing.jpg" height="380">
                            ...
                            <v-card class="elevation-0 transparent">
                                ...
                                <v-card-text>
                                    ...
                                    <v-flex xs12 class="text-xs-center" v-if="!subscribed">
                                        <v-btn class="blue lighten-2 mb-5" dark large @click="subscribe">Get in
                                            touch</v-btn>
                                    </v-flex>
                                    <v-flex xs12 class="text-xs-center" v-if="subscribed">
